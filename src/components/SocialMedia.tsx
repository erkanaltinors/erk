...
return(
    <div className="flex gap-2 py-5">
        <div>
            ...
            ><LinkedinLogo weight="duotone" className="text-white" size={32}/></a>
        </div>
        <div>
            <a 
            ...
            ><GithubLogo weight="duotone" className="text-white" size={32} /></a>
        </div>
        <div>
            <a 
                ...
                ><TwitterLogo weight="duotone" className="text-white" size={32} /></a>
        </div>
    </div>
)
}