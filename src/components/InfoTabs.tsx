                ...
                <ScrollArea className="h-[calc(100vh-300px)] w-full text-white focus:outline-none">
                    <div className="grid grid-cols-1 gap-2 rounded-md p-4">
                        ...
                        <div className="grid grid-cols-1 gap-2">
                            ...
                            <div>
                                <ul className="list-none [&>li:before]:content-['⭐_'] [&>li:not(:last-child)]:mb-2">
                                    ...
                                    <li>Building strategies to improve web site speed,</li>
                                    <li>
                                        Made collaboration with back-end team and management to decrease project publish
                                        date.
                                    </li>
                                    <li>20+ finished projects & 50+ maintained projects.</li>
                                    <li>
                                        Won 4 rewards from different committees such as Altın Örümcek and Horizon
                                        Interactive Awards.
                                    </li>
                                </ul>
                                <p className="mt-2">
                                    I've taught 4 interns in 2021. 3 of them started as Junior Front-end Developer in
                                    this company.
                                </p>
                            </div>
                            <div>
                        ...
                        <div className="grid grid-cols-1 gap-2">
                            ...
                            <div>
                                <p>
                                    Implement, style and add interactions to web pages for e-commercial website which
                        ...
                        <div className="grid grid-cols-1 gap-2">
                            ...
                            <div>
                                ...
                                <p className="mt-2">
                                    Product mentioned <span className="font-semibold">Visilabs</span> is similar to
                                    Google Analytics.
                                </p>
                            </div>
                            <div>
